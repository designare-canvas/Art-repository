    ...
    <Grid container spacing={2} className="indent" >
      ...
      <Grid item xs={12} sm={12} className="filter">
        ...
        {/* <Box
          ...
          autoComplete="off"
        > */}
          <TextField id="outlined-basic" style={{width:"100%"}} label="Seach Tags" variant="outlined" size="small"/>
      ...
      <Grid item xs={12} sm={12} >
        {/* <Box
          ...
          style={{padding:"8px"}}
        >  */}
        { isMobile ?(<><Stack direction="row" style={{ justifyContent: "space-between"}}>

<FormControl sm={6} sx={{ minWidth: 140, minHeight: 20 }} style={{ height: "40px" }}>
  <InputLabel id="demo-simple-select-helper-label" size="small">Explore</InputLabel>
  <Select
...
<FormControl sm={6} sx={{ minWidth: 140 }}>
  <InputLabel id="demo-simple-select-helper-label" size="small">Filter</InputLabel>
  <Select
    labelId="demo-simple-select-helper-label"
    id="demo-simple-select-helper"
    value={age}
