...
function ViewPost() {
  ...
  const initDiscription =
    'dkfjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjdfjkdljjjjjjjjjjjjjjjjfkjgggggggggllllllllllllllllllllllllllllllllllllllllllllllldddddddddddddddddddddddddddddddddddddddddddddllllljjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj';
      ...
      <div className="postbody">
        ...
        <div className="postImg">
          <img
            ...
            alt="posts"
            style={{ width: '30vw', borderRadius: '10px', height: '30vw' }}
          />
        </div>
