...
export default function Profile() {
  ...
  var bio="hello there"// change it by the bio of user
  var name="Ak Chauhan"//change it by the name of user
        ...
        <div className="profileRight">
          <div className="profileRightTop">
            ...
            <div className="profileInfo">
                ...
                <Button className="btn" variant="text">{follower} Follower</Button>
                <Button className="btn" variant="text">{following} Following</Button>
                </span>
      ...
      >
        ...
        <Tab value="three" label="About" className="tabs"/>
          ...
          <span className="profileInfoDesc">
                ...
                <Button className="btn" variant="text" disabled>India</Button>
                </span>
                <span className="profileInfoDesc">
                <Button className="btn" variant="text" disabled>Date of Birth</Button>
                <Button className="btn" variant="text" disabled>10/10/10</Button>
                </span>
